...
const PropertyFormPage2 = ({ propertyDetails, setPropertyDetails, onSubmit }) => {
...
const handleInputChange = (e) => {
  ...
  setPropertyDetails((prev) => ({
    ...prev,
    [name]: ["fireDoor", "fireAlarm"].includes(name) ? value === "Yes" : value, // Convert "Yes"/"No" to true/false for fireDoor and fireAlarm
  }));
};
